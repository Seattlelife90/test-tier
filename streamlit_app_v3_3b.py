...
# v3.3b — Fix process_results signature; robust shim for v2_5 import
import sys
...
st.set_page_config(page_title="Game Pricing — v3.3b (Clean UX)", page_icon="🎮", layout="wide")
...
st.title("Game Pricing Recommendation Tool — v3.3b (Xbox · Steam · PlayStation)")
st.caption("Paste **URLs only**. Platforms are fully siloed with their own markets & currencies from v2.5 (no cross-talk).")
...
def run_fetch(which: str):
    ...
    # FIX: process_results in v2_5 expects exchange rates
